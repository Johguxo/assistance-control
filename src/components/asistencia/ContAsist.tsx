...
export const ContAsist: React.FC = () => {
  ...
  const handleCheckboxChange = async (
    ...
    setUsers(
      users.map((user) =>
        user._id === userId ? { ...user, [day]: !checked } : user
      )
    );
  };
        ...
        >
          ...
          <div className="flex flex-col w-4/5 h-4/6 items-center justify-center">
            ...
            {loading ? (
              ...
              <>
                <div
                  className={`h-screen overflow-x-auto shadow-md shadow-slate-600/50 bg-blue-200 ${
                    selectedOption === 0 || selectedOption === 5
                      ? `w-full`
                      : `w-11/12`
                  }`}
